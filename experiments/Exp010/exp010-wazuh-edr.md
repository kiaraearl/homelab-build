...
📸 `exp010-01-wazuh-install-complete.png`
...
📸 `exp010-02-wazuh-dashboard-login.png`
...
📸 `exp010-03-agent-win11-active.png`
...
📸 `exp010-04-fim-event-triggered.png`
...
📸 `exp010-05-brute-force-detected.png`
📸 `exp010-06-rule-5712-mitre-detail.png`
📸 `exp010-07-alert-raw-fields.png`
...
📸 `exp010-08-active-response-blocked.png`
...
📸 `exp010-09-vulnerability-detection-summary.png`
📸 `exp010-10-critical-cves-list.png`
...
- [Exp003 — SSH Hardening & fail2ban](exp003-fail2ban.md)
- [Exp005 — Nessus Vulnerability Scanning](exp005-nessus.md)
- [Exp007 — Microsoft Sentinel](exp007-sentinel.md)
- [Exp009 — CIC Incident Operations](exp009-cic-incident-ops.md)
